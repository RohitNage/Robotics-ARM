...
theta_2=numpy.pi/4+0.1024
theta_3=numpy.pi/4-0.1024


p0sub = p0.subs({theta1:theta_1, theta2:theta_2, theta3:theta_3, theta4:theta_4, theta5:theta_5, theta6:theta_6})
p1sub = p1.subs({theta1:theta_1, theta2:theta_2, theta3:theta_3, theta4:theta_4, theta5:theta_5, theta6:theta_6})
p2sub = p2.subs({theta1:theta_1, theta2:theta_2, theta3:theta_3, theta4:theta_4, theta5:theta_5, theta6:theta_6})
p3sub = p3.subs({theta1:theta_1, theta2:theta_2, theta3:theta_3, theta4:theta_4, theta5:theta_5, theta6:theta_6})
p4sub = p4.subs({theta1:theta_1, theta2:theta_2, theta3:theta_3, theta4:theta_4, theta5:theta_5, theta6:theta_6})
p5sub = p5.subs({theta1:theta_1, theta2:theta_2, theta3:theta_3, theta4:theta_4, theta5:theta_5, theta6:theta_6})
p6sub = p6.subs({theta1:theta_1, theta2:theta_2, theta3:theta_3, theta4:theta_4, theta5:theta_5, theta6:theta_6})
